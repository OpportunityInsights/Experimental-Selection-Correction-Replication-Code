...
# Use pacman to install and load the required packages
p_load(haven, lmtest, dplyr, ggplot2, tidyr,glmnet,fixest,grf,writexl,readxl,ggpubr,openxlsx,svglite,rlang,doParallel,foreach)
# Define the path to your data folder
DATA_PATH <- "~/exp_obs"

```

## the nyc_extract to dataset_for_kevin part
